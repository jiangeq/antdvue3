...
import outsideLayout from '@/router/staticModules/outsideLayout';
...
import { REDIRECT_ROUTE } from '@/router/staticModules/besidesLayout';

// 需要放在所有路由之后的路由
const endRoutes: RouteRecordRaw[] = [REDIRECT_ROUTE];
...
export function filterAsyncRoute(
  ...
  return routes
    ...
    .map((item) => {
      ...
      const { router, name, icon, orderNum, keepalive } = item;
      let fullPath = '';
